...
def loading_screen(progress):
    ...
    pygame.display.flip()
def stateload():
    global save, save_path, progress, platforms, uncollide_plats, txt, inv_counts, inv_items, player_x, player_y, state
    if save:
        try:
            save_path = save[0]
            ...
            player_x, player_y = float(plr[0]), float(plr[1])-2
            progress = 0.25
...
while running:
    ...
    if state == "menu":
        ...
        if not play_open and not controls_open:
            ...
            pygame.draw.rect(screen, (52, 52, 52), load_button_rect, border_radius=10)
            pygame.draw.rect(screen, (0, 0, 0), load_button_rect, 2, border_radius=10)
